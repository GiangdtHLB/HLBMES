"""Test báo cáo điện SCADA ngoài theo site — deployment này chỉ phục vụ nhà máy Đông Mai
(site "hl"/Hạ Long đã bị gỡ 2026-09-11, xem services/energy_external.py::SITE_PURPOSE)."""
...
def test_dm_purpose_resolves_own_connection(client, admin_h):
    """Tạo 1 kết nối cho Đông Mai (purpose=energy_dm) — bounds phải đi xa hơn bước resolve
    connection và không còn báo "chưa có kết nối nào được gán"."""
