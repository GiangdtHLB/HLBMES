...
lượng" ở tab Chất lượng (mirror của Lô NVL chờ khai báo, nhưng gộp các công đoạn sản xuất của
pipeline "Mẻ sản xuất": mẻ nấu/tank lên men chính+phụ/lô lọc/lô thành phẩm). Xem
services/qc_catalog.py::list_pending_stage_declarations.
"""
