...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('unit_class', sa.Unicode(length=255), nullable=True),
        sa.Column('up_name', sa.Unicode(length=255), nullable=False),
        sa.Column('op_name', sa.Unicode(length=255), nullable=False),
        sa.Column('phase_name', sa.Unicode(length=255), nullable=False),
        sa.Column('state', sa.Unicode(length=255), nullable=False, server_default='running'),
        ...
        sa.Column('operator', sa.Unicode(length=255), nullable=True),
