...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('kind', sa.String(length=255), nullable=False, server_default='production'),
        sa.Column('wo_id', sa.String(length=64), nullable=True),
        sa.Column('wo_code', sa.String(length=64), nullable=True),
        sa.Column('product', sa.String(length=255), nullable=True),
        sa.Column('status', sa.String(length=255), nullable=False, server_default='planned'),
