...
PERMISSION_CATALOG = {
    ...
    "warehouse.transfer_approve_factory": "Duyệt điều chuyển sang nhà máy khác",
    "warehouse.count_approve": "Duyệt phiếu kiểm kê định kỳ",
    "wms.confirm_shipment": "Xác nhận phiếu xuất kho thành phẩm (Trưởng bộ phận kho)",
    "wms.confirm_receipt": "Duyệt nhập kho từ chiết (Trưởng bộ phận kho)",
