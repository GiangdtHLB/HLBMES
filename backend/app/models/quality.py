...
from sqlalchemy import Text, DateTime, Float, String
...
class QualityResult(Base):
    ...
    instrument: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
    ...
    status: Mapped[str] = mapped_column(String(255), default=ResultStatus.PENDING.value)
...
class Deviation(Base):
    ...
    deviation_id: Mapped[str] = mapped_column(String(64), primary_key=True, default=new_id)
    deviation_code: Mapped[str] = mapped_column(String(64), unique=True, index=True)
    scope_type: Mapped[str] = mapped_column(String(255), default="batch")
    scope_id: Mapped[str] = mapped_column(String(64), index=True)
    severity: Mapped[str] = mapped_column(String(255), default="minor")  # minor/major/critical
    reason: Mapped[str] = mapped_column(Text)
    state: Mapped[str] = mapped_column(String(255), default=DeviationState.OPEN.value)
    investigation: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)
