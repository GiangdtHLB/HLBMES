...
class ProductionLine(Base):
    ...
    kind: Mapped[str] = mapped_column(String, default="line", index=True)  # line | tank | brewhouse
    area: Mapped[Optional[str]] = mapped_column(String, nullable=True)   # khu vực (chiet/len_men/...)
