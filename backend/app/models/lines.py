...
class ProductionLine(Base):
    ...
    code: Mapped[str] = mapped_column(String(64), unique=True, index=True)   # tên line (khớp OEERecord.line)
    name: Mapped[str] = mapped_column(String(255))
    kind: Mapped[str] = mapped_column(String(255), default="line", index=True)  # line | tank | brewhouse
    area: Mapped[Optional[str]] = mapped_column(String(255), nullable=True)   # khu vực (chiet/len_men/...)
