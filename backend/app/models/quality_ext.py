...
class QCParameter(Base):
    ...
    stage: Mapped[Optional[str]] = mapped_column(String, nullable=True)  # nau|len_men|loc|chiet
...
class CAPA(Base):
    ...
    capa_id: Mapped[str] = mapped_column(String, primary_key=True, default=new_id)
    capa_code: Mapped[str] = mapped_column(String, unique=True, index=True)
    deviation_id: Mapped[Optional[str]] = mapped_column(String, nullable=True, index=True)
    title: Mapped[str] = mapped_column(String)
    capa_type: Mapped[str] = mapped_column(String, default="corrective")  # corrective | preventive
    ...
    action_plan: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    effectiveness: Mapped[Optional[str]] = mapped_column(String, nullable=True)
...
class Sample(Base):
    ...
    sample_id: Mapped[str] = mapped_column(String, primary_key=True, default=new_id)
    sample_code: Mapped[str] = mapped_column(String, unique=True, index=True)
    ...
    test_set: Mapped[Optional[str]] = mapped_column(String, nullable=True)  # csv tên parameter cần test
    registered_by: Mapped[Optional[str]] = mapped_column(String, nullable=True)
