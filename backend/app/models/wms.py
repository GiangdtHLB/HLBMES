...
from sqlalchemy import Boolean, DateTime, Float, ForeignKey, Integer, Unicode
...
class Pallet(Base):
    ...
    pallet_id: Mapped[str] = mapped_column(Unicode(64), primary_key=True, default=new_id)
    pallet_code: Mapped[str] = mapped_column(Unicode(64), unique=True, index=True)
...
class Case(Base):
    ...
    case_id: Mapped[str] = mapped_column(Unicode(64), primary_key=True, default=new_id)
    case_code: Mapped[str] = mapped_column(Unicode(64), unique=True, index=True)
