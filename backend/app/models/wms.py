...
class WmsLocation(Base):
    ...
    loc_id: Mapped[str] = mapped_column(String, primary_key=True, default=new_id)
    code: Mapped[str] = mapped_column(String, unique=True, index=True)
    name: Mapped[str] = mapped_column(String)
    zone: Mapped[Optional[str]] = mapped_column(String, nullable=True)
    kind: Mapped[str] = mapped_column(String, default="bin")     # bin | staging | cold | dock
...
class Pallet(Base):
    ...
    pallet_id: Mapped[str] = mapped_column(String, primary_key=True, default=new_id)
    pallet_code: Mapped[str] = mapped_column(String, unique=True, index=True)
    ...
    status: Mapped[str] = mapped_column(String, default="building", index=True)  # building|stored|shipped
...
class Case(Base):
    ...
    case_id: Mapped[str] = mapped_column(String, primary_key=True, default=new_id)
    case_code: Mapped[str] = mapped_column(String, unique=True, index=True)
