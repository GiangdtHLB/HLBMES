...
class MaterialRequest(Base):
    ...
    `source_type`/`source_id` (tuỳ chọn): gắn phiếu với 1 Lệnh nấu (brew_order) hoặc 1 Lệnh SX
    (ERP, production_order) — chỉ để tham chiếu/lọc/báo cáo (KHÔNG ràng buộc số lượng dòng
    theo lệnh), vì phòng xưởng vẫn tự do thêm/sửa/xoá dòng sau khi hệ thống tự động điền sẵn
    từ định mức NVL của lệnh (xem services/warehouse.py::preview_source_materials)."""
