...
class ScheduleSlot(Base):
    ...
    slot_id: Mapped[str] = mapped_column(Unicode(64), primary_key=True, default=new_id)
    resource: Mapped[str] = mapped_column(Unicode(255), index=True)     # FV-01.. | Line-1.. | Nồi nấu
    kind: Mapped[str] = mapped_column(Unicode(255), default="production")  # production | cip | maintenance
    wo_id: Mapped[Optional[str]] = mapped_column(Unicode(64), nullable=True, index=True)
